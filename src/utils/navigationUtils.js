...
export const useBackNavigation = () => {
  ...
  const goBack = (defaultPath = '/all-products') => {
    ...
    if (referrer) {
      ...
      } else if (currentPath.includes('/new-arrivals-wish')) {
        // If we're on wish genie product page, go back to wish genie with search params
        navigate('/new-arrivals-wish' + location.search);
      } else {
